...
const productImages = [
  {
    ...
    alt: "Product Image 1",
    cornerClass: "rounded-tl-[16px] sm:rounded-tl-[24px] md:rounded-tl-[32px]",
  },
  {
    id: 2,
    src: "/image/productThumb2.png",
    alt: "Product Image 2",
    cornerClass: "rounded-tr-[16px] sm:rounded-tr-[24px] md:rounded-tr-[32px]",
  },
  {
    id: 3,
    src: "/image/productThumb1.png",
    alt: "Product Image 3",
    cornerClass: "rounded-bl-[16px] sm:rounded-bl-[24px] md:rounded-bl-[32px]",
  },
  {
    id: 4,
    src: "/image/productThumb3.png",
    alt: "Product Image 4",
    cornerClass: "rounded-br-[16px] sm:rounded-br-[24px] md:rounded-br-[32px]",
  },
];
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full md:w-[65%]">
                ...
                {productImages.map((_, index) => (
                  <button
                    ...
                    className={`w-1.5 h-1.5 rounded-full transition-colors ${
                      activeImageIndex === index ? "bg-accent" : "bg-primary/50"
                    }`}
          ...
          <div className="hidden md:grid grid-cols-2 gap-4">
            {productImages.map((img) => (
              <div
                key={img.id}
                className={`bg-card-bg-secondary w-full min-h-[510px] overflow-hidden ${img.cornerClass}`}
              >
                <Image
                  src={img.src}
                  alt={img.alt}
        ...
        <div className="w-full md:w-[35%] flex flex-col  gap-6 md:gap-8 ">
          <div>
            ...
            <p className="text-[24px] font-bold text-accent">$125.00</p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 max-w-[95%] font-sans ">
              <p className="text-primary/70">Shadow Navy / Army Green</p>
